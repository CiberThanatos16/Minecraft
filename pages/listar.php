            ...
            <div class="bg-light shadow btn-border">
                <div class="p-5">
                    ...
                    <p>Que tal?
                        ...
                        hasta puedes incluir mobs hechos por ti, incluye los nombres, el tipo y la descripcion del mob.
                        :D</p>
                    <hr>
                    <h2>Mobs</h2><br>
                        ...
                        <?php foreach ($mobs as $mobs): ?>
                            <div class="col">
                                ...
                                <div class="card-footer bg-transparent border-info">
                                    ...
                                    <a href="index.php?action=eliminar&id_mob=<?php echo $mobs["id_mob"]; ?>"
                                        onclick="return confirm('¿Estás seguro de eliminar este mob?')">Eliminar</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div><br>
